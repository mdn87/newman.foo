 ...
 * thruster-particles.ts default their palettes from THEMES.light.
 */
export interface Theme {
  ...
  thrusterMain: Rgb; thrusterDeep: Rgb;
}
...
export const THEMES: Record<ThemeName, Theme> = {
  light: {
    ...
    thrusterMain: rgb(0x4ab3d4), thrusterDeep: rgb(0x16324a),
  },
  dark: {
    bg: rgb(0x1e2125),
    ...
    thrusterMain: rgb(0xff8c4d), thrusterDeep: rgb(0xb4562a),
  },
};
